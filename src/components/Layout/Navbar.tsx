    ...
    <nav className="bg-white shadow-sm border-b border-gray-200">
        ...
        <div className="flex justify-between h-16">
          <div className="flex">
            <div className="flex-shrink-0 flex items-center">
              <span className="text-xl font-semibold text-primary2">Allocation Nexus</span>
            </div>
      ...
      <div className="sm:hidden flex justify-around border-t border-gray-200 bg-white fixed bottom-0 left-0 right-0 z-50">
        <Link
          to="/"
          className={`${
            isActive('/') ? 'text-primary2' : 'text-gray-500'
        ...
        <Link
          to="/consultants"
          className={`${
            isActive('/consultants') ? 'text-primary2' : 'text-gray-500'
          } group flex flex-col items-center px-4 py-2 text-xs font-medium`}
        >
        ...
        <Link
          to="/projects"
          className={`${
            isActive('/projects') ? 'text-primary2' : 'text-gray-500'
          } group flex flex-col items-center px-4 py-2 text-xs font-medium`}
        >
