          ...
          <div id="project-details"> {/* Keep id if used for e.g. e2e tests */}
            ...
            />
              ...
              <div>
                ...
                <span key={skill} className="text-xs bg-[#0f161e]/80 px-2 py-1 rounded-full text-[#ffe704]\\n">
                      {skill}
                    </span>)}
                </div>
              </div>
              ...
              <div className="flex justify-end mt-8">
                <Button onClick={onContinue} disabled={!project} className="flex items-center bg-[transparent#ffe704] bg-[#ffe704] text-[#0f161e]">
